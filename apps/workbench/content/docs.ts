  ...
  },
  {
    slug:"glossary",title:"Glossary",group:"Reference",summary:"Actual GIS terminology and lifecycle semantics.",sections:[
      {id:"terms",title:"A–Z",terms:[
        ...
        {term:"Recovered late",definition:"An obligation satisfied after its preferred due time through bounded catch-up or retry. Current health may recover while historical lateness remains recorded."},
        {term:"Awaiting first scheduled run",definition:"A neutral automation state: the first scheduled obligation is still in the future, so no execution was expected yet."},
        {term:"Stored source record",definition:"A physical append-only source row, including historical revisions where the source can restate data."},
        {term:"Current observation",definition:"The effective, non-superseded version of a governed observation."},
