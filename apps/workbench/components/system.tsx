...
type Capability = {items: {schedule: string; status: string; latest_success: string | null; stale_since: string | null}[]; fixture_ai_provider: boolean; production_ai_operational: boolean};
