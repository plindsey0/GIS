...
const links=[["/","Overview"],["/goals","Goals"],["/opportunities","Opportunities"],["/recommendations","Recommendations"],["/interventions","Interventions"],["/evidence","Evidence"],["/markets","Market"],["/collection","Collection"],["/providers","Data Providers"],["/experiments","Experiments"],["/outcomes","Outcomes"],["/system","System"],["/docs","Learn GIS"]];
